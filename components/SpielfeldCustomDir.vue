<template>
	<div
		class="SpielfeldCustomDir-container"
	...
	>
		...
		<Avatar
			...
			:style="[
				getMeStyles,
				{
					transform: `translate(${getMe.x + 15}px, ${getMe.y - 200}px) scale(0.3)`,
		...
		<OtherAvatar
			...
			:style="[
				user.styles,
				{
					...
					transform: `translate(${user.x}px, ${user.y - 200}px) scale(0.3)`,
					transition: `transform 1s`,
				},
			]"
		/>
