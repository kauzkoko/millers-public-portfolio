<template>
	<!-- Webcam -->
	<div class="K-2-10-container">
		<div class="K-2-10-main">
			<DirectionController
				:noTop="false"
				:noRight="false"
				:noBottom="false"
			...
			<div
				class="animate__animated animate__slideInDown K-2-10-wolke1"
				v-bind:style="{
					left: getRandomInt(0, 20) + '%',
					top: getRandomInt(-10, 0) + '%',
				}"
			>
				<img class="K-2-10-img2" src="~static/images/objects/wolke1.png" />
			</div>
			<div
				class="animate__animated animate__slideInLeft K-2-10-wolke2"
				v-bind:style="{
					left: getRandomInt(10, 30) + '%',
					top: getRandomInt(-10, 0) + '%',
				}"
			>
				<img class="K-2-10-img2" src="~static/images/objects/wolke2.png" />
			</div>
			<div
				class="animate__animated animate__slideInDown K-2-10-wolke3"
				v-bind:style="{
			...
			<div
				class="animate__animated animate__slideInRight K-2-10-wolke4"
				v-bind:style="{
...
export default {
	...
	data() {
		return {
			...
			random5: -200,
			random6: -200,
			gadgetClass: "animate__animated animate__infinite K-2-10-img",
			animClasses: [
				"animate__bounce",
				"animate__heartBeat",
				"animate__flip",
