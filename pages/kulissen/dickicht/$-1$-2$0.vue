<template>
	<!-- Webcam -->
	<div class="K-1-20-container">
		<div class="K-1-20-main">
			<DirectionController
				:noTop="true"
				:noRight="false"
				:noBottom="false"
			...
			<div
				class="animate__animated animate__slideInDown K-1-20-wolke1"
				v-bind:style="{
					left: getRandomInt(0, 20) + '%',
					top: getRandomInt(-10, 0) + '%',
				}"
			>
				<img class="K-1-20-img2" src="~static/images/objects/wolke1.png" />
			</div>
			<div
				class="animate__animated animate__slideInLeft K-1-20-wolke2"
				v-bind:style="{
					left: getRandomInt(10, 30) + '%',
					top: getRandomInt(-10, 0) + '%',
				}"
			>
				<img class="K-1-20-img2" src="~static/images/objects/wolke2.png" />
			</div>
			<div
				class="animate__animated animate__slideInDown K-1-20-wolke3"
				v-bind:style="{
			...
			<div
				class="animate__animated animate__slideInRight K-1-20-wolke4"
				v-bind:style="{
...
export default {
	...
	data() {
		return {
			...
			random5: -200,
			random6: -200,
			gadgetClass: "animate__animated animate__infinite K-1-20-img",
			animClasses: [
				"animate__bounce",
				"animate__heartBeat",
				"animate__flip",
